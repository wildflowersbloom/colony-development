% Intitialize (user inputs numbers of ants in all detections in frame f)

function [obj clicked] = initialize (obj,f,v,listAlive,video_start,windowTitle,arena,varargin)
...
for i=1:length (aliveNow)
    ...
    %text(this_tracklet.x(lf)+2,this_tracklet.y(lf)+12,num2str(this_tracklet.area(lf)),'Color','red');
